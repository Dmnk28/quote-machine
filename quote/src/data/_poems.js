const poems = [
    ...
    {
        title:      'rubāʿīy 7',
        text:       '<div class="qasida"><div class="sadr">هر روز دلم بـه زیر باری دگر اسـت</div><div class="ajuz">در دیده من ز هجر خاری دگر اسـت</div><div class="sadr">مـن جـهد همی‌کنم قضا می‌گوید</div><div class="ajuz">بیرون ز کـفایت تو کاری دگراسـت</div></div>', 
        trans:      '<p>Täglich sinkt mir eine Bürde anderer Art auf\'s Herz,<br/>Schaft ein anderer Dorn der Trennung meinem Auge Schmerz;</p><p>Ich bemühe mich beständig, doch das Schicksal spricht:<br/>"Anderes gibt es noch, zu welchem dir die Kraft gebricht"</p>',
    ...
    {
        title:      'rubāʿīy 25',
        text:       '<div class="qasida"><div class="sadr">ای دوست دل از جفای دشمن درکش</div><div class="ajuz">با روی نکو شراب روشـن درکـش</div><div class="sadr">با اهـل هنر گوی گریبان بگـشای</div><div class="ajuz">وز نااهـلان تـمام دامـن درکـش</div></div>', 
        trans:      '<p>Behandle, Freund, nicht grausam deinen Feind;<br/>Trink\' lauteren Wein und sei vergnügt dabei;</p><p>Den Kunstliebenden gib deinen Kragen Preis<br/>Doch von den Schurken mach\' den Saum dir frei.</p>',
        author:     'Ḫwāǧe Šams ad-Dīn Moḥammad Ḥāfeẓ-e Šīrāzī',
        death:      '(† ca. 1390 n. Chr. / 792 d. H.)',
        autlink:    'https://en.wikipedia.org/wiki/Hafez',
        source:     'Dīwāne Ḥāfeẓ'    
    ...
    {
        title:      'rubāʿīy 33',
        text:       '<div class="qasida"><div class="sadr">ای شرمزده غنچه مـسـتور از تو</div><div class="ajuz">حیران و خجل نرگس مخـمور از تو</div><div class="sadr">گـل با تو برابری کـجا یارد کرد</div><div class="ajuz">کو نور ز مـه دارد و مـه نور از تو</div></div>', 
        trans:      '<p>Du, vor dem die keusche Knospe sich errötend neigt<br/>Und die trunkene Narzisse Scham und Staunen zeig!</p><p>Kann mit dir doch selbst die Rose sich vergleichen nicht,<br/>Denn sie borget von dem Monde, er von dir das Licht.</p>',
        author:     'Ḫwāǧe Šams ad-Dīn Moḥammad Ḥāfeẓ-e Šīrāzī',
        death:      '(† ca. 1390 n. Chr. / 792 d. H.)',
        autlink:    'https://en.wikipedia.org/wiki/Hafez',
        source:     'Dīwāne Ḥāfeẓ'
    ...
    {
        title:      'ʾUmayma',
        text:       '<div class="qasida"><div class="sadr"></div><div class="ajuz"></div><div class="sadr"></div><div class="ajuz"></div><div class="sadr"></div><div class="ajuz"></div></div>', 
        trans:      '<p>Oh dass ich wissen könnte, was nun ʾUmayma denkt,<br/>Und ob sie die Gedanken noch auf den Fernen lenkt!</p><p>Ob zwischen uns geschlungen besteht treu das Band<br/>Der Liebe, oder Glauben sie falschen Reden schenkt!</p><p>Nun, wenn du Jahresfristen von ihr enfernet bleist,<br/>Dann wirst du wohl erfahren, was freut dich oder kränkt.</p><p><br/></p>',
    ...
    },
    {
        title:      'Māwīya',
        text:       '<div class="qasida"><div class="sadr"></div><div class="ajuz"></div><div class="sadr"></div><div class="ajuz"></div><div class="sadr"></div><div class="ajuz"></div></div>', 
        trans:      '<p>Oh Māwīya, gwährst du nach nächt\'gem Ritte Rast?<br/>Sprich, oder ob beschlossen du unsre Trennung hast,</p><p>Damit ich ganz verzweifle! ja deutlich rede du,<br/>Und vom verworrnen Zweifeln gibt mir die Trennung Ruh.</p>',
    ...
    */
    ...
    {
        title:      'Gedicht 101',
        text:       '<div class="qasida"><div class="sadr">أَحَسِبْتَ مَجْلِسِـنا وحُسْـ</div><div class="ajuz">ـنَ حَديـثِنا يُودي بِمالِكْ</div><div class="sadr">فَالمالُ وَالأَهْلونَ مَصْرَ</div><div class="ajuz">عَةٌ لِأمْرِكَ أو نَكَـالِكْ</div><div class="sadr">ما تَأْمُــرَنْ فينـا فَأَمْـ</div><div class="ajuz">ـرُكَ في يَمينِكَ أو شَمالِكْ</div></div>', 
        trans:      '<p>Glaubst du, dass die Gesellschaft mit uns und die Schicklichkeit<br/>der Konversation deine Besitztümer zerstören würden?</p><p>Besitztümer und Menschen sind ein Schlachtfeld<br/>für deine Herrschaft oder für deine Züchtigung</p><p>Was auch immer du in Bezug auf uns anordnest,<br/>die Anordnung liegt in deiner Rechten oder in deiner Linken.</p>',
        author:     'ʿAdī ibn Zayd al-ʿIbādī',
        death:      '(† ca. 600 n. Chr. / 22 v. d. H.)',
        autlink:    'https://en.wikipedia.org/wiki/Adi_ibn_Zayd',
        source:     'Dīwān ʿAdī ibn Zayd (Übersetzung nach Josef Horovitz)'
